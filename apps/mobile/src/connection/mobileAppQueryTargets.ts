...
export interface MobileCheckpointDiffTarget {
...
export function normalizeMobileComposerPathSearchQuery(query: string | null): string {
  return query?.trim() ?? "";
}

export function buildMobileCheckpointDiffTargets(target: MobileCheckpointDiffTarget) {
  if (
