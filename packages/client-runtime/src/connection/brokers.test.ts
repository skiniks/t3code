...
const makeDependencies = Effect.fn("TestConnectionBroker.makeDependencies")((options?: {
  ...
  return Effect.succeed(connectionBrokerLayer.pipe(Layer.provide(dependencies)));
});
