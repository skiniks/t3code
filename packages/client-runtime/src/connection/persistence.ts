...
import type { ConnectionRegistration } from "./catalog.ts";
...
>()("@t3tools/client-runtime/connection/persistence/ConnectionTargetStore") {}
...
>()("@t3tools/client-runtime/connection/persistence/ConnectionRegistrationStore") {}
